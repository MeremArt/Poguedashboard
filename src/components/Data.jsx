...
export const data = [
  ...
  },
  {
    ...
    icon: <MdOutlinePending  size={23} />,
  },
  {
    id: 5,
    case: "Ended WL Raffle",
    icon: <RxBlendingMode  size={23}/>,
  },
  {
    id: 3,
  ...
  // {
  //   id: 10,
  //   case: "Reported Communities",
  //   icon: <MdOutlineReportOff  size={23} />,
  // },
  // {
  //   id: 11,
  //   case: "Reported Users",
...
export const topUserHeader = ["User", "Total Orders", "Total Spending"];
export const latestOrder = ["OrderId", "User", "Total Price", "Date", "Status"];
export const userlistsheader = [
  "Name",
  "Email",
  "Phone",
  "Total Orders",
